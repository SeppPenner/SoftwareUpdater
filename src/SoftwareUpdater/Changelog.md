...
* **Version 1.0.8.0 (2026-08-17)** : Updated NuGet packages, moved to Net 10.0, fixed the swapped text and title in the error message box, fixed the update check for files without version information, added a test project, publish the setup content self contained.
